...
Example using <code>expcoll</code>.  Unfortunately clicking the expand/collapse arrow scrolls the file back to the top.
`r mu$expcoll('short text', 'much longer text')`
...
x <- htmltools::tagList(lapply(p, plotly::as.widget))
