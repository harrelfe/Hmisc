...
```{r summaryM,fig.width=7,fig.height=5,top=1}
...
mu$citeulikeShow('harrelfe', c('cox58reg', 'cox72'))
# Show and optionally export all articles with a given tag
mu$citeulikeExport('harrelfe', 'missing-data')
```
