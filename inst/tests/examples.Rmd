...
```{r support}
getHdata(support2)
p <- with(support2, histboxp(x=meanbp, group=dzgroup, sd=TRUE,
                             bins=200))
putHfig(p, "Spike histograms, means, quantiles, Gini's mean difference, and SD for MAP stratified by diagnosis",
