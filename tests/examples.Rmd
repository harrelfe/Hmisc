...
p <- plot(d)
# Just to show that HTML formatting can be used.  The use of HTML here
# is the only reason results='asis' was needed in the chunk header
#names(p) <- paste0('### ', names(p), mu$lspace,
#                   mu$smaller(mu$italics('produced by plot.describe')))
